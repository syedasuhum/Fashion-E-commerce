<%@ Page Title="" Language="C#" MasterPageFile="~/fashion/Fashion.master" AutoEventWireup="true" CodeFile="filter_img1.aspx.cs" Inherits="fashion_filter_img1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page" style="color:#313131">Best Seller</li>
      <li><span class="p-2">|</span></li>
      <li class="breadcrumb-item active" aria-current="page" style="color:#313131">Sweatshirt</li>
    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col-lg-5 col-md-6 col-12">
                <div class="tiles">
                 <div class="tile img-fluid" id="first" data-scale="2.4" data-image="images/filter1.1.jpg"></div>
                 <div class="tile img-fluid" id="second" data-scale="2.4" data-image="images/filter1.2.jpg"></div>
                    <div class="tile img-fluid" id="third" data-scale="2.4" data-image="images/filter7.1.jpg"></div>
                    <div class="tile img-fluid" id="four" data-scale="2.4" data-image="images/filter8.1.jpg"></div>
                    <div class="tile img-fluid" id="five" data-scale="2.4" data-image="images/filter13.1.jpg"></div>
                    <div class="tile img-fluid" id="six" data-scale="2.4" data-image="images/filter10.2.jpg"></div>
                    </div>
              
                <div class="owl-caro_img owl-carousel">
                    <div class="item">
                        <img src="images/filter1.1.jpg" class="img-fluid p-2 b1"  onClick="myFunction()" />
                        <%--<img src="images/filter1.1.jpg" class="img-fluid p-2" />--%>
                    </div>
                    <div class="item">
                       <img src="images/filter1.2.jpg" class="img-fluid p-2 b2"  onClick="myFunction2()" />
                       <%-- <img src="images/filter1.2.jpg" class="img-fluid p-2" />--%>
                    </div>
                    <div class="item">
                         <img src="images/filter7.1.jpg" class="img-fluid p-2 b3"  onClick="myFunction3()" />
                    </div>
                    <div class="item">
                         <img src="images/filter8.1.jpg" class="img-fluid p-2 b4"  onClick="myFunction4()" />
                    </div>
                    <div class="item">
                         <img src="images/filter13.1.jpg" class="img-fluid p-2 b5"  onClick="myFunction5()" />
                    </div>
                    <div class="item">
                         <img src="images/filter10.2.jpg" class="img-fluid p-2 b6"  onClick="myFunction6()" />
                    </div>
                </div>
            ...
            <div class="col-lg-7 col-md-6 col-12 text-margin">
                ...
                <ul class="ull">
                    <li class="d-flex"><h6 class="w-25">PRICE:</h6><h4 class="img-price">Rs. 1,080.00</h4></li>
                    <li class="d-flex mt-2"><h6 class="w-25">BRAND:</h6><h6 class="img-pad">Fazena</h6></li>
                     <li class="d-flex mt-2"><h6 class="w-25">TYPE:</h6><h6 class="img-pad">Sweatshirt</h6></li>
        ...
        <div class="owl-caro_3 owl-carousel text-center">
            ...
            <div class="item">
             ...
             <img  src="images/filter12.1.jpg"  class="img-fluid" />
                  ...
                  <h5 class="float-start">Rs. 8,999.00</h5>
                  </div>
