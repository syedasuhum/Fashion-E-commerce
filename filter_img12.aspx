<%@ Page Title="" Language="C#" MasterPageFile="~/fashion/Fashion.master" AutoEventWireup="true" CodeFile="filter_img12.aspx.cs" Inherits="fashion_filter_img12" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page" style="color:#313131">Best Seller</li>
      <li><span class="p-2">|</span></li>
      <li class="breadcrumb-item active" aria-current="page" style="color:#313131">Casual T-Shirt</li>
    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col-lg-5 col-md-6 col-12">
                <div class="tiles">
                 <div class="tile img-fluid" id="first" data-scale="2.4" data-image="images/filter12.1.jpg"></div>
                 <div class="tile img-fluid" id="second" data-scale="2.4" data-image="images/filter12.2.jpg"></div>
                 <div class="tile img-fluid" id="third" data-scale="2.4" data-image="images/shirt4.jpg"></div>
                 <div class="tile img-fluid" id="four" data-scale="2.4" data-image="images/shirt5.jpg"></div>
                 <div class="tile img-fluid" id="five" data-scale="2.4" data-image="images/shirt6.jpg"></div>
                 <div class="tile img-fluid" id="six" data-scale="2.4" data-image="images/shirt7.jpg"></div>
                 
                    </div>
              
                <div class="owl-caro_img owl-carousel">
                    <div class="item">
                        <img src="images/filter12.1.jpg" class="img-fluid p-2 b1"  onClick="myFunction()" />
                    </div>
                    <div class="item">
                       <img src="images/filter12.2.jpg" class="img-fluid p-2 b2"  onClick="myFunction2()" />
                    </div>
                    <div class="item">
                         <img src="images/shirt4.jpg" class="img-fluid p-2 b3"  onClick="myFunction3()" />
                    </div>
                    <div class="item">
                         <img src="images/shirt5.jpg" class="img-fluid p-2 b4"  onClick="myFunction4()" />
                    </div>
                    <div class="item">
                         <img src="images/shirt6.jpg" class="img-fluid p-2 b5"  onClick="myFunction5()" />
                    </div>
                     <div class="item">
                         <img src="images/shirt7.jpg" class="img-fluid p-2 b6"  onClick="myFunction6()" />
                    </div>
            ...
            <div class="col-lg-7 col-md-6 col-12 text-margin">
                ...
                <ul class="ull">
                    <li class="d-flex"><h6 class="w-25">PRICE:</h6><h4 class="img-price">Rs. 600.00</h4></li>
                    <li class="d-flex mt-2"><h6 class="w-25">BRAND:</h6><h6 class="img-pad">Fazena</h6></li>
                     <li class="d-flex mt-2"><h6 class="w-25">TYPE:</h6><h6 class="img-pad">Casual T-Shirt</h6></li>
                    ...
                    <li class="d-flex myDIV mt-2"><h6 class="w-25">COLOR:</h6><h6 class="red b5 btn" id="red" onClick="myFunction5()"></h6><h6 class="black2 b3 btn" id="black" onClick="myFunction3()"></h6><h6 class="blue3 b4 btn" id="blue" onClick="myFunction4()"></h6><h6 class="white2 b6 btn" id="white" onClick="myFunction6()"></h6></li>
