<%@ Page Title="" Language="C#" MasterPageFile="~/fashion/Fashion.master" AutoEventWireup="true" CodeFile="filter_img3.aspx.cs" Inherits="fashion_filter_img3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page" style="color:#313131">Best Seller</li>
      <li><span class="p-2">|</span></li>
      <li class="breadcrumb-item active" aria-current="page" style="color:#313131">Winter Scarf</li>
    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col-lg-5 col-md-6 col-12">
                <div class="tiles">
                 <div class="tile img-fluid" id="first" data-scale="2.4" data-image="images/filter3.1.jpg"></div>
                 <div class="tile img-fluid" id="second" data-scale="2.4" data-image="images/filter3.2.jpg"></div>
                    <div class="tile img-fluid" id="third" data-scale="2.4" data-image="images/scarf4.jpg"></div>
                    <div class="tile img-fluid" id="four" data-scale="2.4" data-image="images/scarf2.jpg"></div>
                    <div class="tile img-fluid" id="five" data-scale="2.4" data-image="images/scarf3.jpg"></div>
                   
                    </div>
              
                <div class="owl-caro_img owl-carousel">
                    <div class="item">
                        <img src="images/filter3.1.jpg" class="img-fluid p-2 b1"  onClick="myFunction()" />
                    </div>
                    <div class="item">
                       <img src="images/filter3.2.jpg" class="img-fluid p-2 b2"  onClick="myFunction2()" />
                    </div>
                    <div class="item">
                         <img src="images/scarf4.jpg" class="img-fluid p-2 b3"  onClick="myFunction3()" />
                    </div>
                    <div class="item">
                         <img src="images/scarf2.jpg" class="img-fluid p-2 b4"  onClick="myFunction4()" />
                    </div>
                    <div class="item">
                         <img src="images/scarf3.jpg" class="img-fluid p-2 b5"  onClick="myFunction5()" />
                    </div>
            ...
            <div class="col-lg-7 col-md-6 col-12 text-margin">
                ...
                <ul class="ull">
                    ...
                    <li class="d-flex mt-2"><h6 class="w-25">BRAND:</h6><h6 class="img-pad">Scarf</h6></li>
                     <li class="d-flex mt-2"><h6 class="w-25">AVAILABILITY:</h6><h6 class="img-pad" style="color:orange">In Stock</h6></li>
                    
                    <li class="d-flex myDIV mt-2"><h6 class="w-25">COLOR:</h6><h6 class="white b2 btn" onClick="myFunction2()"></h6><h6 class="black2 b3 btn" onClick="myFunction3()"></h6></li>
