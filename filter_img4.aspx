<%@ Page Title="" Language="C#" MasterPageFile="~/fashion/Fashion.master" AutoEventWireup="true" CodeFile="filter_img4.aspx.cs" Inherits="fashion_filter_img4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page" style="color:#313131">Best Seller</li>
      <li><span class="p-2">|</span></li>
      <li class="breadcrumb-item active" aria-current="page" style="color:#313131">Shorts</li>
    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col-lg-5 col-md-6 col-12">
                <div class="tiles">
                 <div class="tile img-fluid" id="first" data-scale="2.4" data-image="images/filter4.1.jpg"></div>
                 <div class="tile img-fluid" id="second" data-scale="2.4" data-image="images/filter4.2.jpg"></div>
                    <div class="tile img-fluid" id="third" data-scale="2.4" data-image="images/short1.jpg"></div>
                    <div class="tile img-fluid" id="four" data-scale="2.4" data-image="images/short2.jpg"></div>
                    <div class="tile img-fluid" id="five" data-scale="2.4" data-image="images/short3.jpg"></div>
                   <div class="tile img-fluid" id="six" data-scale="2.4" data-image="images/fil2.3.jpg"></div>
                    </div>
              
                <div class="owl-caro_img owl-carousel">
                    <div class="item">
                        <img src="images/filter4.1.jpg" class="img-fluid p-2 b1"  onClick="myFunction()" />
                    </div>
                    <div class="item">
                       <img src="images/filter4.2.jpg" class="img-fluid p-2 b2"  onClick="myFunction2()" />
                    </div>
                    <div class="item">
                         <img src="images/short1.jpg" class="img-fluid p-2 b3"  onClick="myFunction3()" />
                    </div>
                    <div class="item">
                         <img src="images/short2.jpg" class="img-fluid p-2 b4"  onClick="myFunction4()" />
                    </div>
                    <div class="item">
                         <img src="images/short3.jpg" class="img-fluid p-2 b5"  onClick="myFunction5()" />
                    </div>
                     <div class="item">
                         <img src="images/fil2.3.jpg" class="img-fluid p-2 b6"  onClick="myFunction6()" />
                    </div>
            ...
            <div class="col-lg-7 col-md-6 col-12 text-margin">
                ...
                <ul class="ull">
                    <li class="d-flex"><h6 class="w-25">PRICE:</h6><h4 class="img-price">Rs. 1,050.00</h4></li>
                    ...
                    <li class="d-flex mt-2"><h6 class="w-25">SIZE:</h6><h6 class="size-bor b1" onclick="colorFunction1()">MEDIUM</h6><h6 class="size-bor b2"  onclick="colorFunction2()">LARGE</h6><h6 class="size-bor b3"  onclick="colorFunction3()">X-LARGE</h6></li>
                    <li class="d-flex myDIV mt-2"><h6 class="w-25">COLOR:</h6><h6 class="white b5 btn" id="white" onClick="myFunction5()"></h6><h6 class="gray b3 btn" id="gray" onClick="myFunction3()"></h6><h6 class="brown b4 btn" id="brown" onClick="myFunction4()"></h6><h6 class="blue2 b1 btn" id="blue" onClick="myFunction()"></h6></li>
        ...
        <div class="owl-caro_3 owl-carousel text-center">
            ...
            <div class="item">
             ...
             <img  src="images/filter11.1.jpg"  class="img-fluid" />
                  <div class="img-text mt-1">
                   <h5>SunGlasses</h5>
                  <h5 class="float-start">Rs. 680.00</h5>
                  </div>
