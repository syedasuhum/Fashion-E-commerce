<%@ Page Title="" Language="C#" MasterPageFile="~/fashion/Fashion.master" AutoEventWireup="true" CodeFile="filter_img8.aspx.cs" Inherits="fashion_filter_img8" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page" style="color:#313131">Best Seller</li>
      <li><span class="p-2">|</span></li>
      <li class="breadcrumb-item active" aria-current="page" style="color:#313131">Hoodies and Jackets</li>
    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col-lg-5 col-md-6 col-12">
                <div class="tiles">
                 <div class="tile img-fluid" id="first" data-scale="2.4" data-image="images/filter8.1.jpg"></div>
                 <div class="tile img-fluid" id="second" data-scale="2.4" data-image="images/filter8.2.jpg"></div>
                    <div class="tile img-fluid" id="third" data-scale="2.4" data-image="images/fil8.1.jpg"></div>
                    <div class="tile img-fluid" id="four" data-scale="2.4" data-image="images/filter13.1.jpg"></div>
                    <div class="tile img-fluid" id="five" data-scale="2.4" data-image="images/fil4.1.jpg"></div>
                   <div class="tile img-fluid" id="six" data-scale="2.4" data-image="images/fil8.2.jpg"></div>
                    </div>
              
                <div class="owl-caro_img owl-carousel">
                    <div class="item">
                        <img src="images/filter8.1.jpg" class="img-fluid p-2 b1"  onClick="myFunction()" />
                    </div>
                    <div class="item">
                       <img src="images/filter8.2.jpg" class="img-fluid p-2 b2"  onClick="myFunction2()" />
                    </div>
                    <div class="item">
                         <img src="images/fil8.1.jpg" class="img-fluid p-2 b3"  onClick="myFunction3()" />
                    </div>
                    <div class="item">
                         <img src="images/filter13.1.jpg" class="img-fluid p-2 b4"  onClick="myFunction4()" />
                    </div>
                    <div class="item">
                         <img src="images/fil4.1.jpg" class="img-fluid p-2 b5"  onClick="myFunction5()" />
                    </div>
                     <div class="item">
                         <img src="images/fil8.2.jpg" class="img-fluid p-2 b6"  onClick="myFunction6()" />
                    </div>
            ...
            <div class="col-lg-7 col-md-6 col-12 text-margin">
                ...
                <ul class="ull">
                    <li class="d-flex"><h6 class="w-25">PRICE:</h6><h4 class="img-price">Rs. 1,920.00</h4></li>
                    <li class="d-flex mt-2"><h6 class="w-25">BRAND:</h6><h6 class="img-pad">Fazena</h6></li>
                     <li class="d-flex mt-2"><h6 class="w-25">TYPE:</h6><h6 class="img-pad">Hoodies and Jackets</h6></li>
                    ...
                    <li class="d-flex myDIV mt-2"><h6 class="w-25">COLOR:</h6><h6 class="pink3 b1 btn" id="pink" onClick="myFunction()"></h6><h6 class="white2 b2 btn" id="white" onClick="myFunction2()"></h6><h6 class="black2 b3 btn" id="black" onClick="myFunction3()"></h6></li>
